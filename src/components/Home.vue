...
<div>
    ...
    <section class="section-blue">
        ...
        <div class="scroll-indicator">
            <span>↓</span> <!-- You can replace this with an SVG or an icon for a better look -->
        </div>
    </section>
    <section class="section-white">
        <div class="video-container">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/adLj6kygwds?si=hNQmtCXad6XG66Un" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/ovLbCvq7FNA?si=oIGuqdtoOW7ZXRgD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        <div class="content">
            <h1>Our Approaches</h1>
            <p>This paragraph will describe the video content or relate to your site's theme. Watch and learn more about our exciting educational opportunities!</p>
        </div>
    </section>
    <!-- <section class="section-white">
        <div class="content">
    ...
    <section class="section-white">
        <div class="content">
            <div>
                <h1>Introducing:</h1>
                <WhiteSectionContent :heading="'Edutain Nepal:A fun paathsaala'" :text="'Explore Implement and Achieve'"></WhiteSectionContent>
            </div>
        </div>
    </section>
    <hr>
    <section class="section-white">
        <div class="content">
            <h1>We Offered:</h1>
            <div class="container">
                <ProgrammedContent title="Practical Skill Development" description="Practical skill development through hands-on activities, simulations, and real-world projects." />
                <ProgrammedContent title="Holistic Learning Approach" description="Adoption of a holistic learning approach that integrates academic knowledge with practical skills." />
                <ProgrammedContent title="Technology Integration:" description="Integration of technology into educational practices, including the use of digital tools, online platforms, educational apps" />
                <ProgrammedContent title="Inclusive Education Initiatives" description="Commitment to inclusive education initiatives that promote diversity, equity, and accessibility for all learners." />
